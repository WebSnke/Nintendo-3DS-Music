...
const regex = {
    ...
    shopping: /(?<!\.)((store|www)\.)?(adidas|alibaba|amazon|asos|bestbuy|costco|duolingo|ebay|etsy|flipkart|idealo|myntra|newegg|nike|overstock|puma|rakuten|sephora|shopify|steam|target|thegithubshop|ulta|walmart|zalando|zappos|zara)\.|(.store$)/
};
